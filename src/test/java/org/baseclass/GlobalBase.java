...
public class GlobalBase {
	...
	public String readExcel(int rownum,int cellnum) {
		String value=null;
		try {
			 file=new File("C:\\Users\\hp\\Downloads\\SwagLabProject\\SwagLabProject\\Database\\SauceLab.xlsx");
	...
	public void screenshot(String filename) {
		try {
			...
			File destination=new File("C:\\Users\\hp\\Downloads\\SwagLabProject\\SwagLabProject\\ScreenShot"+filename+".png");
